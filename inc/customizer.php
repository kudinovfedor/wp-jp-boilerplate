...
function jp_customize_register($wp_customize)
{
    ...
    $wp_customize->add_setting('google_map_project_setup_api_key', array('default' => '',));
    $wp_customize->add_setting('google_map_project_setup_map_selector', array('default' => 'google-map',));
    $wp_customize->add_setting('google_map_project_setup_height', array('default' => 400,));
    $wp_customize->add_setting('google_map_project_setup_width', array('default' => 600,));
    $wp_customize->add_setting('google_map_project_setup_latitude', array('default' => '',));
    $wp_customize->add_setting('google_map_project_setup_longitude', array('default' => '',));
    $wp_customize->add_setting('google_map_project_setup_zoom_level', array('default' => 3,));
    ...
    $wp_customize->add_setting('google_map_controls_map_type', array('default' => 'horizontal_bar',));
    $wp_customize->add_setting('google_map_controls_zoom', array('default' => 1,));
    $wp_customize->add_setting('google_map_controls_gesture_handling', array('default' => 'auto',));
    $wp_customize->add_setting('google_map_controls_full_screen', array('default' => 0,));
    $wp_customize->add_setting('google_map_controls_street_view', array('default' => 1,));
    $wp_customize->add_setting('google_map_controls_scale', array('default' => 1,));
    $wp_customize->add_setting('google_map_controls_clickable_poi', array('default' => 0,));
    $wp_customize->add_setting('google_map_controls_draggable', array('default' => 1,));
    $wp_customize->add_setting('google_map_controls_double_click_to_zoom', array('default' => 1,));
    $wp_customize->add_setting('google_map_controls_mouse_wheel_to_zoom', array('default' => 1,));
    ...
    $wp_customize->add_setting('google_map_positions_map_type', array('default' => 10,));
    $wp_customize->add_setting('google_map_positions_zoom', array('default' => 6,));
    $wp_customize->add_setting('google_map_positions_street_view', array('default' => 6,));
    $wp_customize->add_setting('google_map_positions_full_screen', array('default' => 11,));
    ...
    $wp_customize->add_setting('google_map_themes_type', array('default' => 'roadmap',));
    $wp_customize->add_setting('google_map_themes_styles', array('default' => 0,));
